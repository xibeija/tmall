	...
	<form action="forecreateOrder" method="post">
				...
				<thead>
					<tr>
						<th colspan="2" class="productListTableFirstColumn"><img
							class="tmallbuy" src="img/site/tmallbuy.png"> <a
					...
					<c:forEach items="${ois}" var="oi" varStatus="st">
						<tr class="orderItemTR">
							...
							<td class="orderItemProductInfo"><a
								...
								class="orderItemProductLink"> ${oi.product.name} </a> <img
								src="img/site/creditcard.png" title="支持信用卡支付"> <img
							...
							<td><span class="orderItemUnitSum"> ￥<fmt:formatNumber
		...
		<div class="orderItemTotalSumDiv">
			<div class="pull-right">
				<span>实付款：</span> <span class="orderItemTotalSumSpan">￥<fmt:formatNumber
						type="number" value="${total}" minFractionDigits="2" /></span>
			</div>
		</div>
