		...
		<div class="reviewProductInfoRightDiv">
			...
			<table class="reviewProductInfoTable">
				<tr>
					...
					<td><span class="reviewProductInfoTablePrice">￥<fmt:formatNumber
								type="number" value="${p.orignalPrice}" minFractionDigits="2" /></span>
						元</td>
				</tr>
				<tr>
					<td>配送</td>
			...
			<div class="reviewProductInfoRightBelowDiv">
				<span class="reviewProductInfoRightBelowImg"><img1
					...
					class="reviewProductInfoRightBelowText">现在查看的是 您所购买商品的信息 于<fmt:formatDate
						value="${o.createDate}" pattern="yyyy年MM月dd" />下单购买了此商品
				</span>
		...
		<div class="makeReviewDiv">
			<form method="post" action="foredoreview">
				...
				<div class="makeReviewButtonDiv">
					<input type="hidden" name="oid" value="${o.id}"> <input
