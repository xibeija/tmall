							...
							$.get(addCartpage, {
								...
								if ("success" == result) {
									...
									$(".addCartButton").attr("disabled",
											"disabled");
									$(".addCartButton").css("background-color",
											"lightgray")
									$(".addCartButton").css("border-color",
											"lightgray")
...
<div class="imgAndInfo">
	...
	<div class="infoInimgAndInfo">
		...
		<div class="productPrice">
			...
			<div class="productPriceDiv">
				<div class="gouwujuanDiv">
					<img height="16px" src="img/site/gouwujuan.png"> <span>
						全天猫实物商品通用</span>
		...
		<div class="buyDiv">
			<a class="buyLink" href="forebuyone?pid=${p.id}"><button
